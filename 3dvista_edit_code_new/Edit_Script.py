...
class Add_Json_Data():
    def __init__(self, path, dbpath):
        ...
        self.number_hotspot = []    # リスト[3,4,5] (1枚目の写真に３枚、、、)
        self.overlays = []  #
        self.areas = []
        self.behaviours = []
        ...
        self._get_overlays() #self.overlaysに、[[１枚目のパノラマのoverlay, , , ],[2枚目のパノラマのoverlay, , , ],[] ,[]]]というリストを格納
    ...
    def remember_panorama_info(self): # script.jsのplayer->definitionsの中の"hfovMin"というキーを持つvalueがパノラマに関する情報
        self.remember_context_panorama() # "hfovMin"というキーのvalueの中身がself.remember_contextに格納されてr￥イル
